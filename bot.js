...
var blockedSongs = ["Shell Shocked ft. Kill The Noise & Madsonik [Official Video]",
...
API.chatLog("Thank you for using OMB! Please check our website for any updates. This bot was created by "+creator+"",true);

console.log("OhMyBot Version "+version+" Activated!");

talk("OhMyBot Version "+version+ " Activated!");
